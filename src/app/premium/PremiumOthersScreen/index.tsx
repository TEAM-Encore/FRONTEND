...
type PremiumOthersScreenRouteProp = RouteProp<
  RootStackParamList,
  'PremiumOthersScreen'
>;

interface PremiumOthersScreenProps {
  route: PremiumOthersScreenRouteProp;
  postList: {
    review_id: any;
    nickname: string;
    title: string;
...
const PremiumOthersScreen: React.FC<PremiumOthersScreenProps> = ({
  postList,
}) => {
...
export default PremiumOthersScreen;
