...
const HomeBannerScreen: React.FC = () => {
  const {bannerId} = useAppRoute('HomeBannerScreen').params;
      ...
      case 1: {
        return (
          <>
            ...
            <Text style={HomeBannerStyles.textContent}>
              뮤지컬에 관심 있다 하시는 분들은 한번씩 들어보셨을 텐데요,
              여러분은 “회전문”을 들으면 어떤 이미지가 떠오르시나요?
            </Text>
            ...
            <Text style={HomeBannerStyles.textContent}>
              앙코르의 캐릭터 또한 입문 뮤랑이들이 회전 뮤랑이가 되어 서로더
              많은 정보를 주고받는 훈훈한 모습을 담아 탄생했답니다~
            </Text>
      ...
      case 2: {
        return (
          <>
            ...
            <Text style={HomeBannerStyles.textContent}>
              그 중에서도 유독 사랑받은 페어는 바로 전동석과 윤공주 페어,
              전동석과 선민 페어입니다. 전동석은 지킬 앤 하이드에서 빠질 수 없는
              인기 배우이기도 한데요, 아직 관람하지 못한 회전 뮤랑이들이 있다면
              꼭 보기를 추천해요!
            </Text>
            <View style={HomeBannerStyles.line} />
            ...
            <View style={HomeBannerStyles.line} />
            <Text style={[HomeBannerStyles.textContent, {marginBottom: 40}]}>
              오늘은 이렇게 앙코르 선정 회전문 공연 TOP3를 알아봤는데요,
              뮤랑이들에게 유익한 시간이었기를 바래요! 다음에도 재밌고 흥미로운
              소식으로 돌아올게요~
            </Text>
          </>
        );
      ...
      case 3: {
        return (
          <>
            ...
            <Text style={HomeBannerStyles.textContent}>
              뮤지컬 정보는 어떻게 얻을까?{`\n`}뮤지컬에 관심이 많아진
              뮤랑이라면 정보를 열심히 찾아보았을 텐데요, 오늘은 바로 빠르고
              손쉽게 찾는 앙코르 100% 활용법을 알려드리려고 합니다!
            </Text>
            <View style={HomeBannerStyles.boldLine} />
            <Text style={HomeBannerStyles.textContentBold}>
              1번 : 게시판 활용하기
            ...
            <Text style={HomeBannerStyles.textContent}>
              ...
              시야, 굿즈, 공연 감상으로! 정보 게시판은 오페라 글라스, 뮤지컬
              용어, 이벤트로 나뉘어져 있어요.
            </Text>
            <View style={{alignItems: 'center', marginVertical: 30}}>
              <Image
                style={HomeBannerStyles.image}
                source={require('@/assets/images/home/banner/Image3-1.png')}
              />
            </View>
            <Text style={HomeBannerStyles.textContent}>
            ...
            <Text style={HomeBannerStyles.textContent}>
              게시글 내에 해시테그를 통해서 간편하게 키워드 검색도 가능하고,
              관심 있는 키워드는 알림까지 등록이 가능해요! 원하는 정보만 쏙쏙
              모아서 확인해보세요.
            </Text>
            <View style={HomeBannerStyles.line} />
            <Text style={[HomeBannerStyles.textContent, {marginBottom: 40}]}>
  ...
  return (
    <SafeAreaView
      edges={['top']}
      style={[HomeBannerStyles.container, {paddingBottom: 40}]}>
      <ScrollView>
