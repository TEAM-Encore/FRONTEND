...
type Props = {
  ...
  onConfirm: (value: ITicketBookListFilter) => void;
};

function TicketBookFilterBottomSheet({
  isOpen,
  close,
  unmount,
  value,
  ...
  return (
    <BottomSheetModal isOpen={isOpen} close={close} unmount={unmount}>
      <Root>
        ...
        <Body>
          {TICKET_BOOK_FILTER_LIST.map(item => {
...
export default TicketBookFilterBottomSheet;
