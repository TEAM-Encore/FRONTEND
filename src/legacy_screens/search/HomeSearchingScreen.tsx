...
type SearchingScreenProp = {
  text: string;
  setText: (value: string) => void;
};

type SearchingScreenNavigationProp = StackNavigationProp<
  RootStackParamList,
  'HomeSearchDefaultScreen'
>;

const MAX_HISTORY = 10;

const HomeSearchingScreen: React.FC<SearchingScreenProp> = ({
  text,
  setText,
}) => {
  const navigation = useNavigation<SearchingScreenNavigationProp>();
...
export default HomeSearchingScreen;
