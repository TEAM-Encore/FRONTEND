...
type ModifyPageRouteProp = RouteProp<RootStackParamList, 'ModifyPage'>;
...
interface ModifyPageRouteProps {
  route: ModifyPageRouteProp;
  setModifyData: React.Dispatch<React.SetStateAction<ModifyData | null>>;
}

const ModifyPage: React.FC<ModifyPageRouteProps> = ({route, setModifyData}) => {
